...
5. ★投資有価証券（IFRS対応・要注意）: 日本基準の場合は「投資有価証券」のみを抽出し、「投資その他の資産」の合計金額は絶対に抽出しないでください。IFRS適用企業の場合は、必ず「非流動資産（または固定資産）」の部にある「その他の金融資産」のみを抽出してください。「流動資産」の中にある「その他の金融資産」は currentAssets に含まれるため合算しないでください。また、「持分法で会計処理されている投資」や「その他の投資」などの勘定科目は絶対に investmentSecurities に含めないでください。
